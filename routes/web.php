...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::post('/admin/registrations/{id}/delete', [EventSettingsController::class, 'deleteRegistration'])->name('admin.registrations.delete');
    ...
    Route::post('/admin/dates/{id}/delete', [EventSettingsController::class, 'deleteRegisterDate'])->name('admin.dates.delete');
    ...
    Route::post('/admin/times/{id}/delete', [EventSettingsController::class, 'deleteRegisterTime'])->name('admin.times.delete');
    ...
    Route::post('/admin/slots/{id}/delete', [EventSettingsController::class, 'deleteRegisterSlot'])->name('admin.slots.delete');
